...
/**
 * Presentation only. The posts and categories are fetched on the server by
 * page.tsx and handed down, so the article text is in the HTML a crawler or an
 * answer engine receives — this component just animates it.
 */
export default function BlogIndex({ posts, categories }: { posts: BlogPost[]; categories: Category[] }) {
